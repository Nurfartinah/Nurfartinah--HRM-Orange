...
WebUI.click(findTestObject('Object Repository/HRM ORANGE/Admin/General Infromation/Page_OrangeHRM/input__organizationname'))

WebUI.click(findTestObject('Object Repository/HRM ORANGE/Admin/General Infromation/Page_OrangeHRM/input__btnSaveGenInfo'))

WebUI.click(findTestObject('Object Repository/HRM ORANGE/Admin/General Infromation/Page_OrangeHRM/li_Organization Name'))
