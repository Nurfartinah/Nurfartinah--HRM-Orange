...
WebUI.click(findTestObject('Object Repository/HRM ORANGE/Admin/General Infromation/Page_OrangeHRM/input_Phone_organizationphone'))
...
WebUI.click(findTestObject('Object Repository/HRM ORANGE/Admin/General Infromation/Page_OrangeHRM/p'))
