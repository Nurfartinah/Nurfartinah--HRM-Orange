...
WebUI.setText(findTestObject('Object Repository/HRM ORANGE/Admin/Page_OrangeHRM/input__workShiftname'), 'Shift for Ramadan')
...
WebUI.verifyElementText(findTestObject('HRM ORANGE/Admin/Page_OrangeHRM/Page_OrangeHRM/span_From time should be less than To time'), 
