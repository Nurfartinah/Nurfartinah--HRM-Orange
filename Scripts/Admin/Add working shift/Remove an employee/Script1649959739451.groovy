...
WebUI.setText(findTestObject('Object Repository/HRM ORANGE/Admin/Page_OrangeHRM/input__workShiftname'), 'Shift for Hari Raya Korban, Jangan delete !')
...
WebUI.click(findTestObject('HRM ORANGE/Admin/Page_OrangeHRM/Page_OrangeHRM/a_Remove'))

WebUI.selectOptionByValue(findTestObject('HRM ORANGE/Admin/Page_OrangeHRM/select_Admin AAdmin Axyz abcOdis AdalwinPet_7c2238'), 
    '54', true)
