...
WebUI.click(findTestObject('Object Repository/HRM ORANGE/Admin/General Infromation/Page_OrangeHRM/input_Tax ID_organizationtaxId'))
...
WebUI.click(findTestObject('Object Repository/HRM ORANGE/Admin/General Infromation/Page_OrangeHRM/li_Tax ID'))

WebUI.setText(findTestObject('Object Repository/HRM ORANGE/Admin/General Infromation/Page_OrangeHRM/input_Tax ID_organizationtaxId'), 
    '')

WebUI.setText(findTestObject('Object Repository/HRM ORANGE/Admin/General Infromation/Page_OrangeHRM/input_Fax_organizationfax'), 
    'chjuuj')
